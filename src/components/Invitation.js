...
import groom from '../images/sachin.JPG';
import bride from '../images/neelam.jpg';
    ...
    backgroundRepeat: "no-repeat"}}  alt="groom" className="img-responsive" />
                            ...
                            <div className="couple-half">
                                ...
                                <div className="desc-bride">
                                    <h3>Neelam Mandhotra</h3>
                                    <h5>D/O Dalip Mandhotra</h5>
                                    <h5>Babita Mandhotra</h5>
                                </div>
                            </div>
                        </div>
